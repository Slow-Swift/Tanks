class SettingsInfoMenu extends Component {
  constructor(...args) {
    super(...args);
    ...
    this.infoImage = new Sprite("infoImage", "Images/SettingsInfoMenu.png",
    false);
    this.infoImage.transform.position = new Vector2(canvas.width / 2, canvas.height / 2);
    this.infoImage.transform.scale = new Vector2(canvas.width / 900, canvas.width / 900);
    this.CloseMenu();
  }
